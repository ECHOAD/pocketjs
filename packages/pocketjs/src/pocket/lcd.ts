...
export const createLCDClient = async ({
  ...
  return {
    ...
    pocket: {
      application: new (await import("./application/query.lcd")).LCDQueryClient({
        requestClient
      }),
      gateway: new (await import("./gateway/query.lcd")).LCDQueryClient({
        requestClient
      }),
      migration: new (await import("./migration/query.lcd")).LCDQueryClient({
        requestClient
      }),
      proof: new (await import("./proof/query.lcd")).LCDQueryClient({
        requestClient
      }),
      service: new (await import("./service/query.lcd")).LCDQueryClient({
        requestClient
      }),
      session: new (await import("./session/query.lcd")).LCDQueryClient({
        requestClient
      }),
      shared: new (await import("./shared/query.lcd")).LCDQueryClient({
        requestClient
      }),
      supplier: new (await import("./supplier/query.lcd")).LCDQueryClient({
        requestClient
      }),
