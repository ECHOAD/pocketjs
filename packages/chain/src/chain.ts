...
const chain: Chain = {
  ...
  codebase: {
    ...
    binaries: {
      'linux/amd64':
        'https://github.com/pokt-network/poktroll/releases/download/v0.1.1/pocket_linux_amd64.tar.gz',
      'linux/arm64':
        'https://github.com/pokt-network/poktroll/releases/download/v0.1.1/pocket_linux_arm64.tar.gz',
      'darwin/amd64':
        'https://github.com/pokt-network/poktroll/releases/download/v0.1.1/pocket_darwin_amd64.tar.gz',
      'darwin/arm64':
        'https://github.com/pokt-network/poktroll/releases/download/v0.1.1/pocket_darwin_arm64.tar.gz'
    },
    consensus: {
      type: 'cometbft',
      version: 'v0.38.12'
    ...
    genesis: {
      name: 'v0.1.1',
      genesisUrl:
        'https://raw.githubusercontent.com/pokt-network/pocket-network-genesis/refs/heads/master/shannon/mainnet/genesis.json'
    },
    sdk: {
      type: 'cosmos',
      version: 'v0.50.13'
  ...
  explorers: [
    ...
    },
    {
      ...
      accountPage:
        'https://shannon.pokt.network/poktroll/account/${accountAddress}'
    }
  ],
